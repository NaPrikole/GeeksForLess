            ...
            <div class="col-lg-12 m-auto">
                <form action="#" method="post">
                    <div class="input-group input-group-lg my-2">
                        ...
                        <input type="text" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm" name="title" id="author">
                    </div>
                    <div class="input-group input-group-lg my-2">
                        <div class="input-group-prepend">
                    ...
                    <div class="input-group input-group-lg my-2">
                        ...
                        <textarea class="form-control" id="short_content" name="description" rows="5"></textarea>
                    </div>
                    <div class="input-group input-group-lg my-2">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroup-sizing-lg">PRICE</span>
                        </div>
                        <input type="text" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm" name="price" id="author">
                    </div>
